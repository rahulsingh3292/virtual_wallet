...
def add_charges_to_admin_account(payment_charges: int,receiving_charges: int, with_user: str ,to_user: str, amount: int) -> None: 
...
class Payment:
  ...
  def make_payment(self,current_user_wallet: Wallet, paying_user_wallet: Wallet, amount: int) -> None: 
